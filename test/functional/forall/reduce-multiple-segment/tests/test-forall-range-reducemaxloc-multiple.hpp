...
#ifndef __TEST_FORALL_RANGE_REDUCEMAXLOC_MULTIPLE_HPP__
#define __TEST_FORALL_RANGE_REDUCEMAXLOC_MULTIPLE_HPP__
...
void ForallRangeReduceMaxLocMultipleTest(RAJA::Index_type first, 
...
TYPED_TEST_P(ForallRangeReduceMultipleTest, ReduceMaxLocMultipleRangeForall)
{
  ...
  ForallRangeReduceMaxLocMultipleTest<DATA_TYPE, WORKING_RES, 
                                      EXEC_POLICY, REDUCE_POLICY>(0, 2115);
}

#endif  // __TEST_FORALL_RANGE_REDUCEMAXLOC_MULTIPLE_HPP__
